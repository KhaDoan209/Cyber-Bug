...
import { Card, Col, Row, Tag, Space, Modal } from 'antd';
...
import {
   ...
   update_detail_task,
} from '../../redux/reducer/taskModalReducer';
...
const ProjectDetail = (props) => {
                     ...
                     {(provided) => {
                        return (
                           ...
                           >
                              ...
                              >
                                 {colum.lstTaskDeTail.length > 0
                                    ? colum.lstTaskDeTail.map((task, index) => {
                                         return (
                                            <Draggable
   ...
   return (
      <div>
         <h1 className='mb-3'>Project Detail</h1>

         <Row gutter={16}>{ColumTask()}</Row>
         <Modal
                     ...
                     <div className='form-group'>
                        ...
                        >
                           {taskDetailModal.assigness.map((mem, index) => {
                              return (
                                 <div
                                    className='col-6 mt-2 mb-2 text-center'
                                    style={{ display: 'flex' }}
                                    key={index}
                                 >
                                    <div>
                                       <img
                                          ...
                                          alt={mem.avatar}
                                       />
                                       <p className='mt-1 ml-1'>{mem.name}</p>
                                    </div>
                                    <div>
                                       <h3
